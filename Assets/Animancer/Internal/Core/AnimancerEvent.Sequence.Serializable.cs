    ...
    partial struct AnimancerEvent
    {
        partial class Sequence
        {
...
#endif
            {
                ...
                /// <summary>The name of the array field which stores the <see cref="callback"/>s.</summary>
                ...
                void ISerializationCallbackReceiver.OnBeforeSerialize()
                {
                    ...
                    for (int i = 1; i < timeCount; i++)
                    {
                        ...
                        time = _NormalizedTimes[i];
                        _NormalizedTimes[i] = _NormalizedTimes[i - 1];
                        _NormalizedTimes[i - 1] = time;
